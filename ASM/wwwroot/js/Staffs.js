            ...
            { "data": "status", "width": "10%" },
            {
                ...
                "render": function (data) {
                    return `<div class="w-100 btn-group" >
                            <a href="/AppUser/Staff/Edit?id=${data}"  class="btn btn-success text-white mx-2">
                            <i class="bi bi-pencil-square"></i>   </a>
                            <a onClick=Delete('/api/Staff/'+${data})  class="btn btn-danger text-white mx-2">
                             <i class="bi bi-trash-fill"></i>   </a>
                            <a href="/AppUser/WorkingSchool/Index?id=${data}&district=Selected"  class="btn btn-info text-white mx-2">
                            <img src="../../images/School.png" style="height:20px;width:25px;" />  </a>
                            <a href="/AppUser/StaffSAP/Index?id=${data}"  class="btn btn-info ext-white mx-2">
                            <img src="../../images/HRSap.png" style="height:20px;width:25px;" />   </a>
                            </div>`
                },
